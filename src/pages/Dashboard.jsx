...
function Dashboard() {
  ...
  return (
    <>
      <div className="animate-dashboard-in mb-8 flex flex-col gap-4 rounded-3xl border border-white/60 bg-white/70 p-5 shadow-xl shadow-slate-200/60 backdrop-blur-2xl dark:border-white/10 dark:bg-white/[0.06] dark:shadow-black/10 sm:flex-row sm:items-end sm:justify-between xl:mb-10">
        <div>
      ...
      <section className="animate-dashboard-in animation-delay-100 mb-8 grid grid-cols-1 gap-5 xl:mb-10 xl:grid-cols-3">
        <div className="rounded-2xl border border-white/70 bg-white/75 p-5 shadow-xl shadow-slate-200/70 backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.06] dark:shadow-black/10 xl:col-span-2">
        ...
        <div className="rounded-2xl border border-white/70 bg-white/75 p-5 shadow-xl shadow-slate-200/70 backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.06] dark:shadow-black/10">
          <h3 className="inline-flex items-center gap-2 text-lg font-semibold text-slate-950 dark:text-white">
      ...
      <section className="animate-dashboard-in animation-delay-200 mb-8 grid grid-cols-1 gap-5 xl:mb-10 xl:grid-cols-5">
        <div
          className={`relative overflow-hidden rounded-3xl border border-white/70 bg-gradient-to-br ${consensusGlow} p-5 shadow-2xl backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.06] xl:col-span-3`}
        >
          <div className="absolute -right-16 -top-16 h-40 w-40 rounded-full bg-blue-400/10 blur-3xl"></div>
          <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
                {[
                  ...
                  <div
                    key={item.label}
                    className="rounded-2xl border border-white/60 bg-white/65 p-3 shadow-lg shadow-slate-200/40 dark:border-white/10 dark:bg-white/[0.05] dark:shadow-black/10"
                  >
            ...
            <div className="flex justify-center lg:min-w-48">
              <div
        ...
        <div className="rounded-3xl border border-white/70 bg-white/75 p-5 shadow-xl shadow-slate-200/70 backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.06] dark:shadow-black/10 xl:col-span-2">
          <h3 className="inline-flex items-center gap-2 text-lg font-semibold text-slate-950 dark:text-white">
      ...
      <section className="animate-dashboard-in animation-delay-100 mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:mb-10 xl:grid-cols-4 xl:gap-5">
        {isLoading
          ? skeletonStats.map((label) => (
              <div
                key={label}
                className="rounded-lg border border-slate-200 bg-white p-5 shadow-xl shadow-slate-200/70 transition-colors duration-300 dark:border-white/10 dark:bg-[#111827] dark:shadow-none"
              >
              ...
              : stats.map((stat) => {
                  ...
                  return (
                    <div
                      key={stat.label}
                      className="group rounded-2xl border border-white/70 bg-white/75 p-5 shadow-xl shadow-slate-200/70 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-blue-400/30 hover:shadow-blue-500/15 dark:border-white/10 dark:bg-white/[0.06] dark:shadow-black/10"
                    >
      ...
      <section className="animate-dashboard-in animation-delay-200 mb-8 grid grid-cols-1 gap-6 xl:mb-10 xl:grid-cols-5">
        <div className="min-w-0 rounded-2xl border border-white/70 bg-white/75 p-4 shadow-xl shadow-slate-200/70 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-blue-400/25 hover:shadow-blue-500/15 dark:border-white/10 dark:bg-white/[0.06] dark:shadow-black/10 sm:p-5 xl:col-span-2">
          ...
          <div className="mt-4 flex items-center justify-center gap-5 text-sm font-medium text-slate-600 dark:text-slate-300">
            {isLoading
              ? ["Buy", "Sell"].map((item) => (
      ...
      <section className="animate-dashboard-in animation-delay-300 mb-8 overflow-hidden rounded-2xl border border-white/70 bg-white/75 shadow-xl shadow-slate-200/70 backdrop-blur-xl transition-all duration-300 hover:border-blue-400/25 hover:shadow-blue-500/15 dark:border-white/10 dark:bg-white/[0.06] dark:shadow-black/10 xl:mb-10">
        <div className="flex flex-col gap-1 border-b border-slate-200 p-5 dark:border-white/10 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h3 className="inline-flex items-center gap-2 text-lg font-semibold text-slate-950 dark:text-white">
        ...
        <div className="scrollbar-fintech overflow-x-auto pb-2">
      ...
      <div className="mt-10 bg-[#111827] border border-white/10 rounded-2xl p-6 shadow-xl">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div className="bg-[#0B1120] p-5 rounded-xl border border-white/5">
  ...
  <div className="mt-8 bg-[#0B1120] rounded-xl p-6 border border-white/5">
    ...
    <p className="text-gray-300 leading-relaxed">
      ...
      <section className="animate-dashboard-in animation-delay-400 grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4 xl:gap-7">
        {isLoading
          ? [0, 1, 2, 3].map((card) => (
              <div
                key={card}
                className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/70 dark:border-white/10 dark:bg-[#111827] dark:shadow-none"
              >
